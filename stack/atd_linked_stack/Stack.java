...
public class Stack implements Representable {
    private Node head;
    ...
    public void printList(){
        if (head==null)
            ...
            Node curr = head;
            System.out.println("Стек на односвязном массиве");
            while(curr!=null){
                System.out.println(" Name: "+curr.getListElement().nameToString()+" Address: "+curr.getListElement().addressToString()+" \n");
                curr=curr.getNext();
            }
            return;
        }
    ...
    @Override
    public void push(char[] name, char[] address) {
        insert(first(),new ListElement(name,address));
    }

    @Override
    public ListElement pop() {
        ListElement t=head.getListElement();
        head=head.getNext();
        return t;
    }
    ...
    public void printNamePopingStack(){
        while(!empty())
                System.out.println(pop().nameToString());
    }

    public void printAddressPopingStack(){
